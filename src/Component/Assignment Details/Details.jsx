...
const Details = () => {
    ...
    return (
        <div data-theme={`${theme ? 'dark' : ''}`}>
            ...
            <div>
                <div className='bg-purple-800 h-50 md:h-80'>
                    <img className=' w-full h-full flex justify-center items-center object-cover' src={assignmentDataId?.thumbnail} alt="" />
                </div>
                <div className="flex flex-col justify-center items-center py-10">
                    <div className={`${theme ? 'bg-purple-800' : 'bg-[#f0f0f0]'} relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto  bg-clip-border shadow-3xl shadow-shadow-500  p-3`}>
                        ...
                        <div className="grid grid-cols-2 gap-4 px-2 w-full ">
                            <div className={`${theme ? 'bg-purple-950' : 'bg-white'} flex flex-col items-start justify-center rounded-2xl  bg-clip-border px-3 py-4  shadow-md`}>
