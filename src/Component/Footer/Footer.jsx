...
const Footer = () => {
    ...
    return (
        <div data-theme={`${theme ? 'dark' : ''}`} className={`${theme ? 'dark-theme' : 'bg-gray-200'} flex flex-col gap-10 py-10 md:p-30 items-center `}>
            <div>
                <footer className="footer footer-horizontal footer-center ">
                    <aside>
                        <img className='w-20 md:w-30' src={`${theme ? '/asset/logo_white.png' : '/asset/logo_blue.gif'}`} alt="" />
                        <p className="font-bold">
                            Collaborate & Learn: Online Group
                            Study
                        </p>
                        <p>Copyright © {new Date().getFullYear()} - All right reserved -By Muksitul Islam</p>
                    </aside>
                </footer>
            </div>

            <div className="flex items-center gap-4">
                <a href='https://github.com/MISFOfficial' target='_blank' className="social-button">
                ...
                <a href='https://www.facebook.com/MISFOfficial?rdid=uVr1OSfK6ASkHCw4&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1FrMbns1CP%2F#' target='_blank' className="social-button">
                    <button className="relative w-12 h-12 rounded-full group cursor-pointer">
                        <div
                ...
                <a href='https://www.youtube.com/@misf-official' target='_blank' className="social-button ">
                    <button className="relative w-12 h-12 rounded-full group cursor-pointer">
                        <div
