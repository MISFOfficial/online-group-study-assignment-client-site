...
const GetApp = () => {
    ...
    return (
        < div className={`${theme ? 'bg-orange-700' : 'bg-orange-500'}  text-white md:py-30  primary-text flex items-center justify-center`}>
            <motion.div
                initial={{ y: 0, opacity: 0 }}
                whileInView={{y:-30, opacity:1}}
                transition={{duration: 2}}
                viewport={{once: true}}
                className='justify-items-center space-y-10 md:space-y-15 lg:space-y-20 pt-15'
            >
